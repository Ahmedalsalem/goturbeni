...
const RIDE_WITH_DRIVER_SELECT =
  "*, driver:profiles!rides_driver_id_fkey(full_name, avatar_url, car_brand, car_model, car_plate, car_color), poster:profiles!rides_posted_by_fkey(full_name, avatar_url)"
