...
export default async function PrivacyPage() {
  ...
  const sectionKeys = ["dataCollected", "purposes", "storage", "retention", "rights", "cookies", "contact"] as const
          ...
          return (
            <Card key={key} className="ring-foreground/5 border-0 shadow-sm">
              <CardContent className="flex items-start gap-4">
                <Shield className="text-primary mt-0.5 size-5 shrink-0" aria-hidden="true" />
                <div>
