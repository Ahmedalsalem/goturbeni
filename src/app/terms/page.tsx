...
export default async function TermsPage() {
  ...
  const sectionKeys = ["service", "obligations", "booking", "liability", "termination", "disputes", "contact"] as const
          ...
          return (
            <Card key={key} className="ring-foreground/5 border-0 shadow-sm">
              <CardContent className="flex items-start gap-4">
                <FileText className="text-primary mt-0.5 size-5 shrink-0" aria-hidden="true" />
                <div>
