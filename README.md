...
- **Çok dilli ve RTL**: Türkçe / Arapça / İngilizce arayüz (`messages/tr.json`, `messages/ar.json`, `messages/en.json` — 903 anahtar birebir eşleşir), cookie tabanlı locale seçimi, Arapça için tam RTL desteği (yön ikonları dahil).
